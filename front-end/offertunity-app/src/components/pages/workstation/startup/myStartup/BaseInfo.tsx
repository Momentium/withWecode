  ...
  return (
    <StBICont>
      ...
      <StFormCont>
        ...
        <StFormWrap>
          <div className="title neces" style={{display: 'inline-block'}}>*스타트업명</div>
          ...
          <SelectBtn mode="sector" width={186} curVal={sector} changeVal={changeVal}/>

          <div className="title neces">*대표기술</div>
          <SelectBtn mode="tech" width={186} curVal={tech} changeVal={changeVal}/>
