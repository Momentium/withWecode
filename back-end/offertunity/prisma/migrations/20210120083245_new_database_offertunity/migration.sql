...
CREATE TABLE `companies` (
    ...
    `member_count` INT,
INDEX `FK_companies_type_id_user_types_id`(`type_id`),
...
INDEX `FK_investment_portfolio_partner_id_partner_infos_id`(`partner_id`),
...
INDEX `FK_IR_requests_partner_id_partner_infos_id`(`partner_id`),
...
CREATE TABLE `partner_infos` (
    ...
    `invested_counts` INT,
INDEX `FK_partner_infos_company_id_companies_id`(`company_id`),
INDEX `FK_partner_infos_interst_technology_id_technologies_id`(`interst_technology_id`),
INDEX `FK_partner_infos_invested_total_id_investment_funds_id`(`invested_total_id`),
...
CREATE TABLE `startup_images` (
    ...
    `company_id` INT NOT NULL,
    `img_url` VARCHAR(191) NOT NULL,
INDEX `FK_startup_images_company_id_startup_infos_id`(`company_id`),

    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `startup_infos` (
    `id` INT NOT NULL AUTO_INCREMENT,
    `company_id` INT NOT NULL,
    `rep` VARCHAR(191),
    `sector_id` INT,
...
INDEX `FK_startup_infos_business_type_id_business_types_id`(`business_type_id`),
INDEX `FK_startup_infos_company_id_companies_id`(`company_id`),
INDEX `FK_startup_infos_core_technology_id_technologies_id`(`core_technology_id`),
INDEX `FK_startup_infos_sector_id_sectors_id`(`sector_id`),
INDEX `FK_startup_infos_service_type_id_service_types_id`(`service_type_id`),
...
-- AddForeignKey
ALTER TABLE `companies` ADD FOREIGN KEY (`type_id`) REFERENCES `user_types`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `invested_from` ADD FOREIGN KEY (`startup_id`) REFERENCES `startup_infos`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `invested_to` ADD FOREIGN KEY (`partner_id`) REFERENCES `companies`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `invested_to` ADD FOREIGN KEY (`series_id`) REFERENCES `investment_series`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `investment_portfolio` ADD FOREIGN KEY (`partner_id`) REFERENCES `partner_infos`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `IR_requests` ADD FOREIGN KEY (`document_id`) REFERENCES `company_documents`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `IR_requests` ADD FOREIGN KEY (`partner_id`) REFERENCES `partner_infos`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `IR_requests` ADD FOREIGN KEY (`startup_id`) REFERENCES `companies`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `partner_infos` ADD FOREIGN KEY (`company_id`) REFERENCES `companies`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `partner_infos` ADD FOREIGN KEY (`interst_technology_id`) REFERENCES `technologies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `partner_infos` ADD FOREIGN KEY (`invested_total_id`) REFERENCES `investment_funds`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `startup_images` ADD FOREIGN KEY (`company_id`) REFERENCES `startup_infos`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `startup_infos` ADD FOREIGN KEY (`business_type_id`) REFERENCES `business_types`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `startup_infos` ADD FOREIGN KEY (`company_id`) REFERENCES `companies`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `startup_infos` ADD FOREIGN KEY (`core_technology_id`) REFERENCES `technologies`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `startup_infos` ADD FOREIGN KEY (`sector_id`) REFERENCES `sectors`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `startup_infos` ADD FOREIGN KEY (`service_type_id`) REFERENCES `service_types`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
